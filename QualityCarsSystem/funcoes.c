...
// Fun��o de login com at� 3 tentativas
...
int login() {
  ...
  // Credenciais padr�o (poderiam futuramente vir de um arquivo ou banco)
  ...
  while (tentativas < 3) {
    ...
    // L� senha caracter por caracter, mascarando com '*'
...
// Salva os dados de um ve�culo em formato CSV (separado por ponto e v�rgula)
...
// L� e exibe todos os ve�culos cadastrados
...
// Permite editar os dados de um ve�culo com base na placa
...
void editarDados() {
  ...
  while (fscanf(arquivo, "%[^;];%[^;];%d;%[^;];%[^\n]\n",
    ...
    // Regrava no arquivo tempor�rio (alterado ou n�o)
  ...
  rename("temp.txt", "veiculos.txt"); // Renomeia arquivo tempor�rio
...
// Remove um ve�culo do arquivo com base na placa
